...
{   
    public static void main (String [] args)
    {
        ...
        // create buttons
        JComponent buttonA = new JButton("A");
        ((JButton) buttonA).setBorderPainted(false); // отключение прорисовки рамки
        ((JButton) buttonA).setFocusPainted(false); // отключение прорисовки специального контура, проявляющегося, если кнопка обладает фокусом ввода
//        button.setContentAreaFilled(false); // отключение закраски кнопки в нажатом состоянии
//        buttonA.setPreferredSize(new Dimension(16, 16)); // setPreferredSize - если в панели; setSize - если в окне сразу
//        buttonA.setMaximumSize(new Dimension(16, 16)); // setPreferredSize - если в панели; setSize - если в окне сразу
//        buttonA.setMinimumSize(new Dimension(16, 16)); // setPreferredSize - если в панели; setSize - если в окне сразу
        ...
        JPanel buttonPanel = new JPanel(new MigLayout("wrap 2")); // filly tells it to take up all the vertical space
        // add growy to all components so they will fit the cell height
        buttonPanel.add(buttonA);
        buttonA = new JButton("не А");
