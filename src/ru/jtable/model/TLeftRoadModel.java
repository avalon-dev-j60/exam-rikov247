...
/**
 * Класс для описания модели заголовка таблицы для T образного перекрестка влево
 */
...
//            )
            .withChild(new ModelFieldGroup("Направо 21", "Направо 21").withManageable(false)
            .withChild(new ModelField("ФЕ Направо 21", "ФЕ"))
            .withChild(new ModelField("ПЕ Направо 21", "ПЕ"))
            )
            .withChild(new ModelFieldGroup("Разворот 22", "Разворот 22").withManageable(false)
            .withChild(new ModelField("ФЕ Разворот 22", "ФЕ"))
            .withChild(new ModelField("ПЕ Разворот 22", "ПЕ"))
            )
            .withChild(new ModelFieldGroup("Итого2", "Итого").withManageable(false)
