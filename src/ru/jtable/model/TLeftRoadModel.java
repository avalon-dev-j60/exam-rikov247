...
/**
 * Класс для описания модели заголовка таблицы для T образного перекрестка вправо
 */
public class TLeftRoadModel {

    private IModelFieldGroup groups[];

    // Превращаем полученную модель в модель заголовка для описания T перекрестка
    public IModelFieldGroup[] getModel() {
        groups = new IModelFieldGroup[]{
            ...
            new ModelFieldGroup("Направление 1-3", "Направление 1-3").withManageable(false)
            .withChild(new ModelFieldGroup("Направление 1", "Направление 1").withManageable(false)
            //            .withChild(new ModelFieldGroup("Налево 12", "Налево 12").withManageable(false)
            //            .withChild(new ModelField("ФЕ Налево 12", "ФЕ").withVisible(false))
            //            .withChild(new ModelField("ПЕ Налево 12", "ПЕ").withVisible(false)))
            .withChild(new ModelFieldGroup("Прямо 1", "Прямо 1").withManageable(false)
            .withChild(new ModelField("ФЕ Прямо 1", "ФЕ"))
            .withChild(new ModelField("ПЕ Прямо 1", "ПЕ")))
            .withChild(new ModelFieldGroup("Направо 14", "Направо 14").withManageable(false)
            .withChild(new ModelField("ФЕ Направо 14", "ФЕ"))
            .withChild(new ModelField("ПЕ Направо 14", "ПЕ")))
            .withChild(new ModelFieldGroup("Разворот 11", "Разворот 11").withManageable(false)
            .withChild(new ModelField("ФЕ Разворот 11", "ФЕ"))
            .withChild(new ModelField("ПЕ Разворот 11", "ПЕ")))
            .withChild(new ModelFieldGroup("Итого1", "Итого").withManageable(false)
            .withChild(new ModelField("ФЕ Итого1", "ФЕ"))
            .withChild(new ModelField("ПЕ Итого1", "ПЕ")))
            )
            .withChild(new ModelFieldGroup("Направление 3", "Направление 3").withManageable(false)
            .withChild(new ModelFieldGroup("Налево 34", "Налево 34").withManageable(false)
            .withChild(new ModelField("ФЕ Налево 34", "ФЕ"))
            .withChild(new ModelField("ПЕ Налево 34", "ПЕ")))
            .withChild(new ModelFieldGroup("Прямо 3", "Прямо 3").withManageable(false)
            .withChild(new ModelField("ФЕ Прямо 3", "ФЕ"))
            .withChild(new ModelField("ПЕ Прямо 3", "ПЕ")))
            //            .withChild(new ModelFieldGroup("Направо 32", "Направо 32").withManageable(false)
            //            .withChild(new ModelField("ФЕ Направо 32", "ФЕ").withVisible(false))
            //            .withChild(new ModelField("ПЕ Направо 32", "ПЕ").withVisible(false)))
            .withChild(new ModelFieldGroup("Разворот 33", "Разворот 33").withManageable(false)
            .withChild(new ModelField("ФЕ Разворот 33", "ФЕ"))
            .withChild(new ModelField("ПЕ Разворот 33", "ПЕ")))
            .withChild(new ModelFieldGroup("Итого3", "Итого").withManageable(false)
            ...
            //            .withChild(new ModelField("ФЕ Налево 23", "ФЕ").withVisible(false))
            //            .withChild(new ModelField("ПЕ Налево 23", "ПЕ").withVisible(false))
            //            )
            //            .withChild(new ModelFieldGroup("Прямо 2", "Прямо 2")
            //            .withChild(new ModelField("ФЕ Прямо 2", "ФЕ").withVisible(false))
            //            .withChild(new ModelField("ПЕ Прямо 2", "ПЕ").withVisible(false))
            //            )
            //            .withChild(new ModelFieldGroup("Направо 21", "Направо 21")
            //            .withChild(new ModelField("ФЕ Направо 21", "ФЕ").withVisible(false))
            //            .withChild(new ModelField("ПЕ Направо 21", "ПЕ").withVisible(false))
            //            )
            //            .withChild(new ModelFieldGroup("Разворот 22", "Разворот 22")
            //            .withChild(new ModelField("ФЕ Разворот 22", "ФЕ").withVisible(false))
            //            .withChild(new ModelField("ПЕ Разворот 22", "ПЕ").withVisible(false))
            //            )
            //            .withChild(new ModelFieldGroup("Итого2", "Итого")
            //            .withChild(new ModelField("ФЕ Итого2", "ФЕ").withVisible(false))
            //            .withChild(new ModelField("ПЕ Итого2", "ПЕ").withVisible(false))
            //            )
            //            )
            .withChild(new ModelFieldGroup("Направление 4", "Направление 4").withManageable(false)
            .withChild(new ModelFieldGroup("Налево 41", "Налево 41").withManageable(false)
            ...
            //            .withChild(new ModelField("ФЕ Прямо 4", "ФЕ").withVisible(false))
            //            .withChild(new ModelField("ПЕ Прямо 4", "ПЕ").withVisible(false))
            //            )
            .withChild(new ModelFieldGroup("Направо 43", "Направо 43").withManageable(false)
            .withChild(new ModelField("ФЕ Направо 43", "ФЕ"))
            .withChild(new ModelField("ПЕ Направо 43", "ПЕ"))
            )
            .withChild(new ModelFieldGroup("Разворот 44", "Разворот 44").withManageable(false)
