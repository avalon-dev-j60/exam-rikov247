...
/**
 * Класс для перемещения компонентов мышью. The Component moved can be a high
 * level Window (ie. Window, Frame, Dialog) in which case the Window is moved
 * within the desktop. Or the Component can belong to a Container in which case
 * the Component is moved within the Container.
 *
