 ...
 */
public class Future4CircleXSLX {

    public Future4CircleXSLX(JBroTable table, XSSFSheet sheet) {
        this(table, sheet, 89);
    }
    
    public Future4CircleXSLX(JBroTable table, XSSFSheet sheet, int rowStart) {
